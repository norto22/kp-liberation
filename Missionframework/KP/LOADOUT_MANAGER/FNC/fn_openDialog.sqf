...
} forEach KPLIB_groups;

// Set initial values for view distances
_ctrlViewFoot ctrlSetText str KPLIB_viewFoot;
_ctrlViewVeh ctrlSetText str KPLIB_viewVeh;
_ctrlViewAir ctrlSetText str KPLIB_viewAir;

// Fill density, auto tpv and radio dropdowns. Also preselect the saved values
_ctrlTerrain lbAdd localize "STR_KPLIB_TERRAINLOW"; // 50
_ctrlTerrain lbAdd localize "STR_KPLIB_TERRAINSTANDARD"; // 25
_ctrlTerrain lbAdd localize "STR_KPLIB_TERRAINHIGH"; // 12.5
_ctrlTerrain lbAdd localize "STR_KPLIB_TERRAINVHIGH"; // 6.25
_ctrlTerrain lbAdd localize "STR_KPLIB_TERRAINULTRA"; // 3.125
_ctrlTerrain lbSetCurSel KPLIB_terrain;

_ctrlTpv lbAdd localize "STR_KPLIB_TPDISABLED";
_ctrlTpv lbAdd localize "STR_KPLIB_TPVAIR";
_ctrlTpv lbAdd localize "STR_KPLIB_TPVLAND";
_ctrlTpv lbAdd localize "STR_KPLIB_TPVALL";
_ctrlTpv lbSetCurSel KPLIB_tpv;

_ctrlRadio lbAdd localize "STR_KPLIB_RADIONO";
_ctrlRadio lbAdd localize "STR_KPLIB_RADIOVOICE";
_ctrlRadio lbAdd localize "STR_KPLIB_RADIOALL";
_ctrlRadio lbSetCurSel KPLIB_radio;

// Initialize sound slider range, position and speed
_ctrlSliderSound sliderSetRange [0, 100];
_ctrlSliderSound sliderSetPosition (KPLIB_soundVeh * 100);
