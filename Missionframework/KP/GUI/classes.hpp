...
class KPLIB_GUI_PRE_CloseCross {
    deletable = 0;
    fade = 0;
    type = 11;
    style = 48 + 2048;
...
class KPLIB_GUI_PRE_VersionIcon: KPLIB_GUI_PRE_CloseCross {
...
class KPLIB_GUI_PRE_Background {
    deletable = 0;
    fade = 0;
    type = 0;
    idc = -1;
...
// Inline Title
class KPLIB_GUI_PRE_InlineTitle: KPLIB_GUI_PRE_Text {
    style = 2;
    sizeEx = KP_TEXT_L;
};

// Active Text
class KPLIB_GUI_PRE_ActiveText {
    deletable = 0;
    fade = 0;
    type = 11;
    style = 2;
...
// Picture
class KPLIB_GUI_PRE_Picture: KPLIB_GUI_PRE_Text {
    style = 48;
};

// Active Picture
class KPLIB_GUI_PRE_ActivePicture: KPLIB_GUI_PRE_ActiveText {
    color[] = {1, 1, 1, 0.5};
    colorActive[] = {1, 1, 1, 1};
    style = 48;
};
...
class KPLIB_GUI_PRE_ActivePictureRatio: KPLIB_GUI_PRE_ActivePicture {
    style = 48 + 2048;
};

// Picture which keeps aspect ratio
class KPLIB_GUI_PRE_PictureRatio: KPLIB_GUI_PRE_Picture {
    style = 48 + 2048;
};

// Button
class KPLIB_GUI_PRE_Button {
    deletable = 0;
    fade = 0;
    type = 1;
    text = "";
...
// Inline Button
class KPLIB_GUI_PRE_InlineButton: KPLIB_GUI_PRE_Button {
...
// Controls group
class KPLIB_GUI_PRE_ControlsGroup {
    deletable = 0;
    fade = 0;
    class VScrollbar: KPLIB_GUI_PRE_ScrollBar {
        color[] = {1, 1, 1, 1};
        width = 0.021;
        autoScrollEnabled = 1;
    };
    class HScrollbar: KPLIB_GUI_PRE_ScrollBar {
        color[] = {1, 1, 1, 1};
        height = 0.028;
    };
    class Controls {};
...
class KPLIB_GUI_PRE_ControlsGroupNoScrollbars: KPLIB_GUI_PRE_ControlsGroup {
...
class KPLIB_GUI_PRE_Combo {
    ...
    maxHistoryDelay = 1;
    class ComboScrollBar: KPLIB_GUI_PRE_ScrollBar {
        color[] = {1, 1, 1, 1};
    };
...
class KPLIB_GUI_PRE_ListBox {
    ...
    tooltipColorBox[] = {1, 1, 1, 1};
    tooltipColorShade[] = {0, 0, 0, 0.65};
    class ListScrollBar: KPLIB_GUI_PRE_ScrollBar {
        color[] = {1, 1, 1, 1};
        autoScrollEnabled = 1;
    };
    colorShadow[] = {0, 0, 0, 0.5};
...
class KPLIB_GUI_PRE_ListNBox {
    ...
    class ScrollBar: KPLIB_GUI_PRE_ScrollBar {};
    style = 16;
    shadow = 0;
    font = "RobotoCondensed";
    sizeEx = KP_TEXT_M;
...
// MapControl
class KPLIB_GUI_PRE_MapControl {
    deletable = 0;
    fade = 0;
    type = 101;
    idc = 51;
...
// Title bar
class KPLIB_GUI_PRE_DialogTitle: KPLIB_GUI_PRE_Title {
...
// Cross symbol
class KPLIB_GUI_PRE_DialogCross: KPLIB_GUI_PRE_CloseCross {
    x = KP_GETX_CROSS(KP_X_VAL);
    y = KP_GETY_CROSS(KP_Y_VAL);
};

// Version info
class KPLIB_GUI_PRE_DialogVersionIcon: KPLIB_GUI_PRE_VersionIcon {
    x = safeZoneX + safeZoneW * (KP_X_VAL + KP_WIDTH_VAL - 0.04);
    y = KP_GETY_CROSS(KP_Y_VAL);
};

// Background
class KPLIB_GUI_PRE_DialogBackground: KPLIB_GUI_PRE_Background {
    x = KP_GETX(KP_X_VAL,KP_WIDTH_VAL,0,1);
...
class KPLIB_GUI_PRE_DialogButton: KPLIB_GUI_PRE_Button {
...
// Title bar
class KPLIB_GUI_PRE_DialogTitleL: KPLIB_GUI_PRE_Title {
...
// Cross symbol
class KPLIB_GUI_PRE_DialogCrossL: KPLIB_GUI_PRE_CloseCross {
    x = KP_GETX_CROSS(KP_X_VAL_L);
    y = KP_GETY_CROSS(KP_Y_VAL_L);
};

// Version info
class KPLIB_GUI_PRE_DialogVersionIconL: KPLIB_GUI_PRE_VersionIcon {
    x = safeZoneX + safeZoneW * (KP_X_VAL_L + KP_WIDTH_VAL_L - 0.04);
    y = KP_GETY_CROSS(KP_Y_VAL_L);
};

// Background
class KPLIB_GUI_PRE_DialogBackgroundL: KPLIB_GUI_PRE_Background {
    x = KP_GETX(KP_X_VAL_L,KP_WIDTH_VAL_L,0,1);
...
// Button pos 1 in 4 button row
class KPLIB_GUI_PRE_DialogButtonL: KPLIB_GUI_PRE_Button {
...
// Title bar
class KPLIB_GUI_PRE_DialogTitleC: KPLIB_GUI_PRE_Title {
...
// Cross symbol
class KPLIB_GUI_PRE_DialogCrossC: KPLIB_GUI_PRE_CloseCross {
    x = safeZoneX + safeZoneW * (KP_X_VAL_C + KP_WIDTH_VAL_C - 0.02);
    y = KP_GETY_CROSS(KP_Y_VAL_C);
};

// Version info
class KPLIB_GUI_PRE_DialogVersionIconC: KPLIB_GUI_PRE_VersionIcon {
    x = safeZoneX + safeZoneW * (KP_X_VAL_C + KP_WIDTH_VAL_C - 0.04);
    y = KP_GETY_CROSS(KP_Y_VAL_C);
};

// Background
class KPLIB_GUI_PRE_DialogBackgroundC: KPLIB_GUI_PRE_Background {
    x = KP_GETX(KP_X_VAL_C,KP_WIDTH_VAL_C,0,1);
...
// Button
class KPLIB_GUI_PRE_DialogButtonC: KPLIB_GUI_PRE_Button {
    x = KP_GETX(KP_X_VAL_C,KP_WIDTH_VAL_C,0,1);
...
// Title bar
class KPLIB_GUI_PRE_DialogTitle_LeftPanel: KPLIB_GUI_PRE_Title {
...
// Cross symbol
class KPLIB_GUI_PRE_DialogCross_LeftPanel: KPLIB_GUI_PRE_CloseCross {
    x = safeZoneX + safeZoneW * (KP_X_VAL_LP + KP_WIDTH_VAL_LP - 0.02);
    y = KP_GETY_CROSS(KP_Y_VAL_LP);
};

// Version info
class KPLIB_GUI_PRE_DialogVersionIcon_LeftPanel: KPLIB_GUI_PRE_VersionIcon {
    x = safeZoneX + safeZoneW * (KP_X_VAL_LP + KP_WIDTH_VAL_LP - 0.04);
    y = KP_GETY_CROSS(KP_Y_VAL_LP);
};

// Background
class KPLIB_GUI_PRE_DialogBackground_LeftPanel: KPLIB_GUI_PRE_Background {
    x = KP_GETX(KP_X_VAL_LP,KP_WIDTH_VAL_LP,0,1);
...
// Button
class KPLIB_GUI_PRE_DialogButton_LeftPanel: KPLIB_GUI_PRE_Button {
    x = KP_GETX(KP_X_VAL_LP,KP_WIDTH_VAL_LP,0,1);
...
class KPLIB_GUI_PRE_LogoRightCorner: KPLIB_GUI_PRE_PictureRatio {
