...
if(isServer) then {
    ...
    GET_PARAM_BOOL(KPLIB_commander_zeus, "CommanderZeus", 1);
    ...
    KPLIB_allow_mapmarkers = KPLIB_mapmarkers; publicVariable "KPLIB_allow_mapmarkers";
    KPLIB_allow_platoonview = KPLIB_mapmarkers; publicVariable "KPLIB_allow_platoonview";
...
if (!isDedicated && hasInterface) then {
    ...
    _value = if (KPLIB_commander_zeus) then {localize "STR_PARAMS_ENABLED";} else {localize "STR_PARAMS_DISABLED";};
    _text = _text + format ["<font color='#ff8000'>%1</font><br />%2<br /><br />", _param, _value];
