...
while {true} do {
    ...
    waitUntil {sleep 0.25;
        !(_KP_liberation_production_old isEqualTo KPLIB_production)
        || !(_KP_liberation_logistics_old isEqualTo KPLIB_logistics)
    };
    {
        private _sector = _x;
        {
    ...
    _KP_liberation_production_old = +KPLIB_production;
    _KP_liberation_logistics_old = +KPLIB_logistics;
};
