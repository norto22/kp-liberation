...
greuh_options_profile = profileNamespace getVariable "KPLIB_OPTIONS_PROFILE";
...
if ( KPLIB_allow_mapmarkers ) then { execVM "GREUH\SCRIPTS\GREUH_playermarkers.sqf"; };
if ( KPLIB_allow_platoonview ) then { execVM "GREUH\SCRIPTS\GREUH_platoonoverlay.sqf"; };
if ( KPLIB_allow_platoonview ) then { execVM "GREUH\SCRIPTS\GREUH_cache_units.sqf"; };
if ( KPLIB_allow_customsquads ) then { execVM "GREUH\SCRIPTS\GREUH_squadmanagement.sqf"; };
if ( KPLIB_allow_viewdistance ) then { execVM "GREUH\SCRIPTS\GREUH_view_distance_management.sqf"; };
